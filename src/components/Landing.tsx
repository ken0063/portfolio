    ...
    >
      <div className="container grid gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-12">
        ...
        <div className="flex flex-col items-start space-y-4">
          <Link
            href="#projects"
            className="inline-flex h-10 items-center justify-center rounded-md bg-teal-700 px-8 text-sm font-medium text-gray-50 shadow transition-colors hover:bg-teal-700/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50/90 dark:focus-visible:ring-gray-300"
            prefetch={false}
          >
            View Projects
          </Link>
